...
from og_marl.systems.hiro import HIROSystemBuilder, ObservationAndActionCritic
...
def build_hiro_system(num_agents, num_actions, environment_factory, logger_factory):
    system = HIROSystemBuilder(
        environment_factory=environment_factory,
        logger_factory=logger_factory,
        hi_policy_network = snt.DeepRNN(
            [
                snt.Linear(128),
        ...
        hi_critic_network = ObservationAndActionCritic(num_agents, num_actions),
        lo_q_network=snt.DeepRNN(
            [
                snt.Linear(64),
                tf.nn.relu,
                snt.GRU(64),
...
def main(_):
    ...
    elif FLAGS.algo_name == "hiro":
        print("RUNNING HIRO")
        system = build_hiro_system(num_agents, num_actions, environment_factory, logger_factory)
