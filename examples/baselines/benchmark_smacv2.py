...
flags.DEFINE_string("base_dataset_dir", "datasets/smac_v2", "Directory with tfrecord files.")
flags.DEFINE_string("env_name", "zerg_5_vs_5", "E.g. 3m, 8m")
flags.DEFINE_string("dataset_quality", "Replay", "E.g. Good, Medium, Poor")
...
def main(_):
    ...
    # Environment factory
    environment_factory = functools.partial(SMACv2, FLAGS.env_name)
